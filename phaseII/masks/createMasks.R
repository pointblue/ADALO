...
#we'll start with >5% suitable to pass the mask
...
spp<-c("SWFL","SACR","TRBL","BOBO","BUOW","SPPI","BAIS","CANV","CCLO","FEHA","LBCU","MAGO","MOPL","NOPI")

#Winter: spp<-c("SACR","TRBL","BUOW","SPPI","CANV","LBCU","MAGO","MOPL","NOPI")

maskdef<-try(readWorksheetFromFile(paste(rpth,"mask/Masks_LandCover_bySpecies.xlsx",sep="/"),sheet="Land_Cover_Vars"))
...
rast<-raster(paste(rpth,"/mask/speciesMasks/CANV_mask01.tif",sep=""))
